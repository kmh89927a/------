...
| F2 배우자 공유 | FUNC-009~014 | UUID v4 링크, 30일 만료, 무료 미리보기 1곳, WTP 설문 |
...
- **[[user]]** — Supabase auth.users.id 참조, mode(couple/single)
- **[[diagnosis]]** — 진단 결과, deadline_mode, filters(JSON)
- **[[share-link-entity]]** — UUID 공유 토큰, 30일 만료, viewCount
...
| 1.2 | Next.js App Router 단일 풀스택 아키텍처 정렬 |
| 1.3 | 상세 시퀀스 다이어그램 6건, Transport Adapter 폴백 |
| 1.4 | Client Component 병렬, window.print() 전환 |
| 1.5 | F5 간이 저장 축소, NFR 완화, ERD 단순화 |
| 1.6 | Supabase Auth 전환, 결제 제거, WTP 설문 |

## 관련 Wiki 페이지

- Entities: [[user]], [[diagnosis]], [[share-link-entity]], [[saved-search]]
- Concepts: [[two-route-intersection]], [[share-link]], [[deadline-mode]], [[single-mode]], [[tech-stack]]
